  ...
  return (
    <section ref={containerRef} id="instalaciones" className="py-24 md:py-32 px-6 max-w-6xl mx-auto relative z-20">
      <div className="mb-12 md:mb-20">
        <h2 className="text-padel font-display text-3xl md:text-5xl lg:text-6xl font-black mb-6 uppercase tracking-tighter leading-[0.9]">INGENIERÍA <br/>DEPORTIVA</h2>
